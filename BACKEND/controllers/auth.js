...
exports.register = async (req, res) => {
  ...
  const { username, email, contact, address, password, type, dept } = req.body; //destructur e method
...
const sendToken = (user, statusCode, res) => {
  ...
  res.status(200).json({ success: true, token, username, email, contact, address, type, dept });
};